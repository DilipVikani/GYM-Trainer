...
public class firstbikramyoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firstbikramyoga);
...

    {
        ...
        countDownTimer = new CountDownTimer(VTimeLeftinmills,1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue<=7){
                    Intent intent = new Intent(firstbikramyoga.this,firstbikramyoga.class);
