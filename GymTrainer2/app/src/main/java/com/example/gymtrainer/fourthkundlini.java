...
public class fourthkundlini extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourthkundlini);
        ...
        switch (intvalue){
            ...
            case 6:
                ...
                break;
            case 7:
                setContentView(R.layout.activity_pose16);
                break;
        }
...

    {
        ...
        countDownTimer = new CountDownTimer(VTimeLeftinmills,1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue<=7){
                    Intent intent = new Intent(fourthkundlini.this,fourthkundlini.class);
