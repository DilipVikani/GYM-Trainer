...
public class forearmsfourth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forearmsfourth);
...

    {
        ...
        countDownTimer = new CountDownTimer(VTimeLeftinmills,1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue<=7){
                    Intent intent = new Intent(forearmsfourth.this,forearmsfourth.class);
