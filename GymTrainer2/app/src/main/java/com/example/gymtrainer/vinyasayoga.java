...
public class vinyasayoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vinyasayoga);
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar();
        newArray = new int[]{
                R.id.pose7, R.id.pose8, R.id.pose9
    ...
    public void ImagebuttonClick(View view) {
            ...
            for (int i=0;i< newArray.length;i++){
                ...
                if(view.getId() == newArray[i]){
                    ...
                    Intent intent = new Intent(vinyasayoga.this, thirdvinyasa.class);
