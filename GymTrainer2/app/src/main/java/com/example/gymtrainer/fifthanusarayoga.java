...
public class fifthanusarayoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifthanusarayoga);
        ...
        switch (intvalue){
            ...
            case 1:
                setContentView(R.layout.activity_pose17);
                break;
            case 2:
                setContentView(R.layout.activity_pose18);
                break;
            case 3:
                setContentView(R.layout.activity_pose19);
                break;
        }
...

    {
        ...
        countDownTimer = new CountDownTimer(VTimeLeftinmills,1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue<=7){
                    Intent intent = new Intent(fifthanusarayoga.this,fifthanusarayoga.class);
