...
public class bikramyoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bikramyoga);
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar();
        newArray = new int[]{
              R.id.pose1,R.id.pose2,R.id.pose3
    ...
    public void ImagebuttonClick(View view) {
        ...
        for (int i=0;i< newArray.length;i++){
            ...
            if(view.getId() == newArray[i]){
                ...
                Intent intent = new Intent(bikramyoga.this, firstbikramyoga.class);
