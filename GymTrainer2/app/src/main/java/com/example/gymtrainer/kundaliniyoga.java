...
public class kundaliniyoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kundaliniyoga);
        ...
        getSupportActionBar();
        newArray = new int[]{
                R.id.pose10,R.id.pose11,R.id.pose12,R.id.pose13,R.id.pose14,R.id.pose15,R.id.pose16
        };
    ...
    public void ImagebuttonClick(View view) {
        ...
        for (int i=0;i< newArray.length;i++){
            ...
            if(view.getId() == newArray[i]){
                ...
                Intent intent = new Intent(kundaliniyoga.this, fourthkundlini.class);
