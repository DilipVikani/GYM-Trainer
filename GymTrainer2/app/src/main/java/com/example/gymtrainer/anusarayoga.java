...
public class anusarayoga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anusarayoga);
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar();
        newArray = new int[]{
                R.id.pose17,R.id.pose18,R.id.pose19
    ...
    public void ImagebuttonClick3(View view) {
        for (int i=0;i< newArray.length;i++){

            if(view.getId() == newArray[i]){
                int value = i+1;
                Log.i("FIRST",String.valueOf(value));
                Intent intent = new Intent(anusarayoga.this,fifthanusarayoga.class);
