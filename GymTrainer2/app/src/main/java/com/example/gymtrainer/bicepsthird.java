...
public class bicepsthird extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bicepsthird);
...

    {
        ...
        countDownTimer = new CountDownTimer(VTimeLeftinmills,1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue<=7){
                    Intent intent = new Intent(bicepsthird.this,bicepsthird.class);
